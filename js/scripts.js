...
$(document).ready(function() {
  $("#questions form").submit(function(event){
    event.preventDefault();
      ...
      } else if (time > 1 && style === "back-end" && company === "Small start-up") {
          $(".ruby").show();
      } else if (time > 1 && style === "back-end" && company === "Large company"){
          $(".php").show();
      } else if (time > 1 && style === "front-end" && company ==="Small start-up"){
          $(".css").show();
      }  else if (time > 1 && style === "front-end" && company === "Large company"){
          $(".design").show();
      } else {
